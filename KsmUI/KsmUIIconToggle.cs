...
namespace KsmUI
{
	public class KsmUIIconToggle : KsmUIImage, IKsmUIInteractable
	{
		...
		public KsmUIIconToggle(KsmUIBase parent, bool initalValue = false, Action<bool> valueChangedAction = null, int iconWidth = -1, int iconHeight = -1)
		...
		public KsmUIIconToggle(KsmUIBase parent, Texture2D whenTrueTexture, Texture2D whenFalseTexture, bool initalValue = false, Action<bool> valueChangedAction = null, int iconWidth = -1, int iconHeight = -1)
			: this(parent, initalValue, valueChangedAction, iconWidth, iconHeight)
		{
			SetStateTexture(whenTrueTexture, whenFalseTexture);
		}

		public KsmUIIconToggle(KsmUIBase parent, Texture2D texture, Kolor whenTrue, Kolor whenFalse, bool initalValue = false, Action<bool> valueChangedAction = null, int iconWidth = -1, int iconHeight = -1)
			: this(parent, initalValue, valueChangedAction, iconWidth, iconHeight)
		{
		...
		public KsmUIIconToggle(KsmUIBase parent, Texture2D texture, Color whenTrue, Color whenFalse, bool initalValue = false, Action<bool> valueChangedAction = null, int iconWidth = -1, int iconHeight = -1)
			: this(parent, initalValue, valueChangedAction, iconWidth, iconHeight)
		{
			Image.texture = texture;
			SetStateColors(whenTrue, whenFalse);
