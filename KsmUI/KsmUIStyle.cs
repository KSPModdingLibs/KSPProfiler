...
namespace KsmUI
{
	public static class KsmUIStyle
	{
        ...
        public static readonly ColorBlock buttonTransitionColorBlock = new ColorBlock()
        {
            normalColor = Color.white,
		...
		{
			highlightedSprite = Textures.KsmUISpriteBtnHighlight,
			pressedSprite = Textures.KsmUISpriteBtnHighlight,
			disabledSprite = Textures.KsmUISpriteBtnDisabled
		};
