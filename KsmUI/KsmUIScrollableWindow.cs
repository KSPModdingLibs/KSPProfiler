...
namespace KsmUI
{
	...
	/// </summary>
	public class KsmUIScrollableWindow : KsmUIBase
	{
			...
			)
		{
			...
			windowObject = new GameObject("KsmUIScrollableWindow");
			...
			windowTransform.SetParentFixScale(KsmUIMasterController.Instance.KsmUITransform);
			windowTransform.localScale = Vector3.one;

			inputLockManager = windowObject.AddComponent<KsmUIInputLock>();
			...
			img.sprite = Textures.KsmUISpriteBackground;
		...
		private class LayoutFitter : MonoBehaviour, ICanvasElement
		{
			...
			public KsmUIScrollableWindow window;
