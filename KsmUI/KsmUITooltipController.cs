...
namespace KsmUI
{
	public class KsmUITooltipController : MonoBehaviour
	{
		public static KsmUITooltipController Instance { get; private set; }
		public bool IsVisible { get; private set; }
		public KsmUITooltipBase CurrentTooltip { get; private set; }
		...
		private void Awake()
		{
			...
			tooltipObject = new GameObject("KsmUITooltip");
			...
			GameObject border = new GameObject("KsmUITooltipBorder");
			...
			GameObject background = new GameObject("KsmUITooltipBackground");
			...
			// last child : text
			GameObject textObject = new GameObject("KsmUITooltipText");
			...
			//KsmUIBase.ApplyCanvasScalerScale(TopTransform); 
		...
		public void ShowTooltip(KsmUITooltipBase tooltip)
		{
			HideTooltip();
