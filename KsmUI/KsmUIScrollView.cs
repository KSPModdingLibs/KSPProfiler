...
namespace KsmUI
{
	public class KsmUIVerticalScrollView : KsmUIBase
	{
		...
		public KsmUIVerticalScrollView(KsmUIBase parent, int contentSpacing = 5, int contentPaddingLeft = 5, int contentPaddingRight = 5, int contentPaddingTop = 5, int contentPaddingBottom = 5) : base (parent)
		{
			...
			scrollRectBackground.color = KsmUIStyle.boxColor;
